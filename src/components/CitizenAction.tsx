          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 mb-8">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-[#CE1126] hover:bg-[#A50B1B] text-white text-xs sm:text-sm font-bold shadow-sm transition-all active:scale-95 shrink-0"
              >
                  ...
                  >
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-2 mb-3">
                        <span className="text-[11px] font-extrabold uppercase px-2.5 py-1 rounded-md bg-red-50 text-[#CE1126]">
                          {prop.category}
                        </span>
                    ...
                    <div className="pt-4 border-t border-neutral-100 flex items-center justify-between">
                      <div className="flex items-center gap-1.5 text-xs font-bold text-neutral-800">
                        <ThumbsUp className={`w-4 h-4 ${isSupported ? 'text-[#CE1126] fill-[#CE1126]' : 'text-neutral-400'}`} />
                      ...
                      <button
                        ...
                        className={`px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 ${
                          isSupported
                            ...
                            : 'bg-neutral-100 hover:bg-red-50 text-neutral-800 hover:text-[#CE1126] border border-neutral-200 active:scale-95'
                        }`}
                      >
                        {isSupported ? (
                          <>
            ...
            {volunteerSubmitted ? (
              ...
              <div>
                <div className="text-center mb-8">
                  <span className="text-xs uppercase font-extrabold tracking-widest text-[#CE1126]">
                    Red Ciudadana
                  </span>
                ...
                <form onSubmit={handleVolunteerSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-neutral-300 text-sm focus:outline-none focus:ring-2 focus:ring-[#CE1126] focus:border-transparent"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-neutral-300 text-sm focus:outline-none focus:ring-2 focus:ring-[#CE1126] focus:border-transparent bg-white"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-neutral-300 text-sm focus:outline-none focus:ring-2 focus:ring-[#CE1126] focus:border-transparent resize-none"
                    ></textarea>
                  </div>
