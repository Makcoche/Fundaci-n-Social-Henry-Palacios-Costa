      ...
      >
        ...
        {submitted ? (
          <div className="text-center py-8">
            ...
            <button
              onClick={handleReset}
              className="px-6 py-2.5 bg-[rgb(220,20,35)] text-white rounded-xl text-xs sm:text-sm font-bold hover:bg-[rgb(180,15,25)] cursor-pointer"
            >
          ...
          <div>
            <div className="mb-6 pr-6">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-red-100 text-[rgb(220,20,35)] text-[11px] font-bold uppercase tracking-wider mb-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-neutral-300 text-sm focus:outline-none focus:ring-2 focus:ring-[rgb(220,20,35)]"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-neutral-300 text-sm focus:outline-none focus:ring-2 focus:ring-[rgb(220,20,35)] bg-white"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-neutral-300 text-sm focus:outline-none focus:ring-2 focus:ring-[rgb(220,20,35)] resize-none"
                ></textarea>
              </div>
              ...
              <div className="pt-2 flex items-center justify-end gap-2.5">
                <button
                  type="button"
                  onClick={handleReset}
                  className="px-4 py-2 text-xs font-bold text-neutral-600 hover:text-neutral-900 rounded-lg cursor-pointer"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-[rgb(220,20,35)] hover:bg-[rgb(180,15,25)] text-white font-bold text-xs sm:text-sm rounded-xl shadow transition-all active:scale-95 flex items-center gap-1.5 cursor-pointer"
                >
